...
# Add line to openModal function for lab professor modal
old_line = "            else if (modalId === 'labAssignModal') loadDropdownData();"
new_line = "            else if (modalId === 'labAssignModal') loadDropdownData(); \n            else if (modalId === 'labProfessorModal') loadLabProfessorModal();"
content = content.replace(old_line, new_line)

# Add JavaScript functions at the end, before closing script tag
js_functions = '''
        // ==========================================
